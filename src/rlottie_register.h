...
#ifndef TK_RLOTTIE_REGISTER_H
#define TK_RLOTTIE_REGISTER_H
...
/**
 * @method  rlottie_supported_render_mode
 * 获取支持的渲染模式。
 *
 * @annotation ["global"]
 *
